...
|                                                                                                                   **강규민**                                                                                                                   |                                                           **박다은**                                                           |                                           **서동현**                                            |                                                                     **송예은**                                                                      |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
| <img src = "https://github.com/R3act-lion/LL_Project-/blob/main/README_img/%E1%84%80%E1%85%A1%E1%86%BC%E1%84%80%E1%85%B2%E1%84%86%E1%85%B5%E1%86%AB_%E1%84%89%E1%85%A1%E1%84%8C%E1%85%B5%E1%86%AB.jpeg?raw=true" width="225px" height="225px"> | <img src = "https://raw.githubusercontent.com/R3act-lion/LL_Project-/main/README_img/ekdms.jpeg" width="225px" height="225px"> | <img src = "https://avatars.githubusercontent.com/u/82585734?v=4" width="225px" height="225px"> | <img src = "https://github.com/R3act-lion/LL_Project-/blob/main/README_img/KakaoTalk_20230104_214539398.jpg?raw=true" width="225px" height="225px"> |
...
- 강규민  
  혼자 작업하면서 자유롭게 작업하는게 너무 습관화가 되었었는데, 팀 프로젝트를 진행하면서 협업을 경험하고 배려와 책임감을 느끼게 되었습니다. 혹시나 내 코드가 남에게 폐를 끼칠까 걱정도 하고 그로인해 코드의 대한 보완을 하게되며 많이 배우게 되어 성장을 할수 있는 계기가 되었구요, 엄청 막 완벽하진 않았지만 팀원분들과 함께 했던 기억들을 돌아보면 기억에 남는 경험이 될 것 같습니다. 추후 리팩토링을 진행해서 완벽한 프로젝트로 만들어 보고 싶습니다.

- 박다은  
  뿌듯함과 아쉬움이 공존했던 프로젝트였다. 제대로 한 첫 번째 프로젝트였기 때문에 중간중간 어려움이 많이 있었지만 하나의 프로젝트를 완성했다는 점이 굉장히 뿌듯했다. 비록 완성에 집중을 하다보니 코드의 품질에 대해 신경쓰지 못한 점이 아쉬움으로 남았지만 리팩토링을 진행하며 위에서 적었던 보완이 필요한 부분을 마무리하게 된다면 기억에 남는 프로젝트가 될 것 같다.

- 서동현  
  프로젝트를 진행하면서 프로젝트를 엎고 다시 진행했고, 시간에 쫓겨 진행하다보니 팀장으로서 역할을 제대로 다 하지 못한 것 같아 아쉬움이 많이 남는 프로젝트였다. 하지만 프로젝트를 진행하며 팀원 모두가 잘 따라와주고, 최선을 다해주는 등 긍정적인 부분도 많아 여러모로 기억에 남을 프로젝트가 될 것 같다.

- 송예은
  나에게는 처음 경험해보는 팀프로젝트를 통해서 단시간 내에 많은 성장이 있었다. 특히 트러블 슈팅이 있을 때 생각지도 못한 방법으로 해결하는 팀원을 보면서 많이 배웠다. 또한 서버통신은 나에게 너무 낯설었었는데 이제는 익숙하게 사용할 수 있게 되었고 이외에도 프로젝트 구조화 하는 방식, 협업할 때 고려할 점 등을 배우게 되어서 정말 값진 시간이었다. 개인 프로젝트를 할 때도 이 프로젝트를 원동력으로 삼아 두려움이 없이 임할 수 있을 것 같다.
